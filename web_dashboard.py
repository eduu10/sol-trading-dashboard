    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .strat-card::before {
            ...
            border-radius: 16px 16px 0 0; transition: opacity 0.3s;
        }
        ...
        .strat-badge {
            padding: 3px 8px; border-radius: 5px; font-size: 0.6em;
            font-weight: 700; letter-spacing: 0.5px; text-transform: uppercase;
        }
            ...
            <div class="strategies-grid">
                ...
                <div class="strat-card risk-alto" id="strat-sniper">
                    <div class="strat-header">
                        ...
                        <div class="strat-help">?
                            <div class="strat-tooltip">
                                ...
                                Usa bots automatizados para detectar e comprar tokens no momento exato do lancamento no Pump.fun, antes que aparecam para usuarios comuns (vantagem de 0.01s vs 60s). Opera em velocidade ultra-rapida (segundos). Risco alto devido a rug pulls e tokens sem liquidez.
                                <div class="strat-tooltip-tools">Ferramentas: <span>Solana Sniper Bot, MEV Bots</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="strat-badges">
                        <span class="strat-badge risk-high">Risco Alto</span>
                    ...
                    <div class="strat-stats">
                        ...
                        <div class="strat-winrate-bar"><div class="strat-winrate-fill" id="strat-sniper-wrbar" style="width:0%;background:var(--red)"></div></div>
                        <div class="strat-stat-row"><span class="strat-stat-label">Rugged</span><span class="strat-stat-value" id="strat-sniper-rug" style="color:var(--red)">0</span></div>
                    </div>
                    <div class="strat-recent">
                ...
                <div class="strat-card risk-alto" id="strat-memecoin">
                    <div class="strat-header">
                        ...
                        <div class="strat-help">?
                            <div class="strat-tooltip">
                                ...
                                Identifica meme coins da Solana com liquidez real, volume crescente e tempo de mercado. Foca em entradas e saidas rapidas baseadas em momentum e analise on-chain de sentimento.
                                <div class="strat-tooltip-tools">Ferramentas: <span>DexScreener, Birdeye, Jupiter</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="strat-badges">
                    ...
                    <div class="strat-stats">
                        ...
                        <div class="strat-winrate-bar"><div class="strat-winrate-fill" id="strat-meme-wrbar" style="width:0%;background:var(--red)"></div></div>
                        <div class="strat-stat-row"><span class="strat-stat-label">Momentum</span><span class="strat-stat-value" id="strat-meme-momentum" style="color:var(--blue)">0</span></div>
                    </div>
                    <div class="strat-recent">
                ...
                <div class="strat-card risk-medio" id="strat-arbitrage">
                    <div class="strat-header">
                        ...
                        <div class="strat-help">?
                            <div class="strat-tooltip">
                                ...
                                Explora diferencas de preco do mesmo token entre Raydium, Jupiter, Meteora e Orca. Executa compra/venda simultanea via bots customizados. Lucro sem risco direcional, porem depende de velocidade de execucao.
                                <div class="strat-tooltip-tools">Ferramentas: <span>Python/Rust Bots, APIs DEX, Jito MEV</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="strat-badges">
                        <span class="strat-badge risk-med">Risco Medio</span>
                        <span class="strat-badge return-badge">Consistente</span>
                    ...
                    <div class="strat-stats">
                        ...
                        <div class="strat-winrate-bar"><div class="strat-winrate-fill" id="strat-arb-wrbar" style="width:0%;background:var(--blue)"></div></div>
                        <div class="strat-stat-row"><span class="strat-stat-label">$/hora</span><span class="strat-stat-value" id="strat-arb-perhr" style="color:var(--green)">$0.00</span></div>
                    </div>
                    <div class="strat-recent">
                ...
                <div class="strat-card risk-medio-baixo" id="strat-scalping">
                    <div class="strat-header">
                        ...
                        <div class="strat-help">?
                            <div class="strat-tooltip">
                                ...
                                Multiplas operacoes rapidas (1-5 min) em tokens com boa liquidez (SOL, JUP, BONK, WIF). Aproveita micro-movimentos de preco com stop-loss rigido. Foco em consistencia e disciplina.
                                <div class="strat-tooltip-tools">Ferramentas: <span>Jupiter Router, Graficos 1m/5m</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="strat-badges">
                        <span class="strat-badge risk-low">Risco Medio-Baixo</span>
                        <span class="strat-badge return-badge">Consistente</span>
                    ...
                    <div class="strat-stats">
                        ...
                        <div class="strat-winrate-bar"><div class="strat-winrate-fill" id="strat-scalp-wrbar" style="width:0%;background:var(--green)"></div></div>
                        <div class="strat-stat-row"><span class="strat-stat-label">Sharpe</span><span class="strat-stat-value" id="strat-scalp-sharpe" style="color:var(--purple)">0.0</span></div>
                    </div>
                    <div class="strat-recent">
                ...
                <div class="strat-card risk-muito-alto" id="strat-leverage">
                    <div class="strat-header">
                        ...
                        <div class="strat-help">?
                            <div class="strat-tooltip">
                                ...
                                Usa Jupiter Perpetuals e Drift Protocol para operar com alavancagem (2x-20x) em SOL e tokens principais. Multiplica exposicao - risco muito alto de liquidacao. Requer gestao de risco rigorosa.
                                <div class="strat-tooltip-tools">Ferramentas: <span>Jupiter Perps, Drift, Mango</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="strat-badges">
                        <span class="strat-badge risk-vhigh">Risco Muito Alto</span>
                        <span class="strat-badge return-badge">Retorno Muito Alto</span>
                    ...
                    <div class="strat-stats">
                        ...
                        <div class="strat-winrate-bar"><div class="strat-winrate-fill" id="strat-lev-wrbar" style="width:0%;background:var(--red)"></div></div>
                        <div class="strat-stat-row"><span class="strat-stat-label">Liquidacoes</span><span class="strat-stat-value" id="strat-lev-liq" style="color:var(--red)">0</span></div>
                    </div>
                    <div class="strat-recent">
                ...
                <div class="strat-card risk-medio" id="strat-whale">
                    <div class="strat-header">
                        <div class="strat-name">Whale Tracking</div>
                        <span class="strat-paused-badge">PAUSADO</span>
                        <div class="strat-help">?
                            <div class="strat-tooltip">
                                <div class="strat-tooltip-title">Seguir Baleias de Crypto</div>
                                Monitora movimentacoes de baleias (grandes holders) via Whale Alert e Solana RPC. Quando baleias compram/acumulam SOL, replica o trade com take profit rapido (5%). Filtra por volume minimo ($100k+) e confianca do sinal.
                                <div class="strat-tooltip-tools">Ferramentas: <span>Whale Alert API, Solana RPC, Jupiter DEX</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="strat-badges">
                        <span class="strat-badge risk-med">Risco Medio</span>
                        <span class="strat-badge return-badge">Retorno Medio-Alto</span>
                        <span class="strat-badge time-badge">Min a Horas</span>
                    </div>
                    <div class="strat-pnl neutral" id="strat-whale-pnl">$0.00</div>
                    <div class="strat-capital">
                        <div class="strat-cap-item"><span class="strat-cap-label">Capital</span><span class="strat-cap-value" id="strat-whale-cap" style="color:var(--yellow)">$100.00</span></div>
                        <div class="strat-cap-item"><span class="strat-cap-label">Investido</span><span class="strat-cap-value" id="strat-whale-inv">$0.00</span></div>
                        <div class="strat-cap-item"><span class="strat-cap-label">Ganhos</span><span class="strat-cap-value" id="strat-whale-gain" style="color:var(--green)">$0.00</span></div>
                        <div class="strat-cap-item"><span class="strat-cap-label">Perdas</span><span class="strat-cap-value" id="strat-whale-loss" style="color:var(--red)">$0.00</span></div>
                        <div class="strat-cap-item strat-cap-full"><span class="strat-cap-label">Hoje</span><span class="strat-cap-value" id="strat-whale-today">$0.00</span></div>
                    </div>
                    <div class="strat-stats">
                        <div class="strat-stat-row"><span class="strat-stat-label">Trades</span><span class="strat-stat-value" id="strat-whale-trades">0</span></div>
                        <div class="strat-stat-row"><span class="strat-stat-label">Win Rate</span><span class="strat-stat-value" id="strat-whale-wr">0%</span></div>
                        <div class="strat-winrate-bar"><div class="strat-winrate-fill" id="strat-whale-wrbar" style="width:0%;background:var(--red)"></div></div>
                        <div class="strat-stat-row"><span class="strat-stat-label">Sinais Detectados</span><span class="strat-stat-value" id="strat-whale-signals">0</span></div>
                        <div class="strat-stat-row"><span class="strat-stat-label">Sinais Seguidos</span><span class="strat-stat-value" id="strat-whale-followed">0</span></div>
                    </div>
                    <div class="strat-recent">
                        <div class="strat-recent-title">Ultimos Trades</div>
                        <div id="strat-whale-recent"></div>
                    </div>
...
function updateStrategies(strats){
    ...
    function setCap(prefix,cap){
        if(!cap)return;
        setText(prefix+'-cap','$'+(cap.current||0).toFixed(2));
        setText(prefix+'-inv','$'+(cap.total_invested||0).toFixed(2));
        setText(prefix+'-gain','$'+(cap.total_gains||0).toFixed(2));
        setText(prefix+'-loss','$'+(cap.total_losses||0).toFixed(2));
        var te=document.getElementById(prefix+'-today');
        if(te){var tp=cap.today_pnl||0;te.textContent=(tp>=0?'+$':'-$')+Math.abs(tp).toFixed(2);te.style.color=tp>=0?'var(--green)':'var(--red)';}
    }
    ...
    if(strats.sniper){const s=strats.sniper.stats||{},c=strats.sniper.capital||{};
        ...
        setText('strat-sniper-rug',s.rugged||0);
    ...
    if(strats.memecoin){const s=strats.memecoin.stats||{},c=strats.memecoin.capital||{};
        ...
        setText('strat-meme-momentum',s.high_momentum_count||0);
    ...
    if(strats.arbitrage){const s=strats.arbitrage.stats||{},c=strats.arbitrage.capital||{};
        ...
        setText('strat-arb-perhr','$'+(s.profit_per_hour||0).toFixed(2));
    ...
    if(strats.scalping){const s=strats.scalping.stats||{},c=strats.scalping.capital||{};
        ...
        setText('strat-scalp-sharpe',(s.sharpe_estimate||0).toFixed(1));
    ...
    // 6. Whale
    if(strats.whale){const s=strats.whale.stats||{},c=strats.whale.capital||{};
        setPnl('strat-whale-pnl',c.pnl_usd||0,false);
        setCap('strat-whale',c);
        setText('strat-whale-trades',s.total_trades||0);
        setText('strat-whale-wr',(s.win_rate||0).toFixed(0)+'%');
        setBar('strat-whale-wrbar',s.win_rate||0);
        setText('strat-whale-signals',s.signals_detected||0);
        setText('strat-whale-followed',s.signals_followed||0);
        setRecent('strat-whale-recent',(strats.whale.recent_trades||[]).slice(0,4),t=>`<div class="strat-recent-item"><span class="strat-recent-name">${t.whale} ${t.move_type}</span><span class="strat-recent-pnl" style="color:${t.pnl_pct>=0?'var(--green)':'var(--red)'}">${t.pnl_pct>=0?'+':''}${t.pnl_pct.toFixed(2)}%</span></div>`);
    }
    // Update pause states
...
async function saveSettings(){
    ...
    try{
        ...
        if(data.ok){
            ...
            status.textContent='Configuracoes salvas! O bot aplicara na proxima iteracao.';
...
async def handle_allocate_strategy(request):
    ...
    try:
        ...
        # Marca como ativo imediatamente no BOT_DATA
        allocs = BOT_DATA.get("allocations")
        if not isinstance(allocs, dict):
            allocs = {}
            BOT_DATA["allocations"] = allocs
        allocs[key] = {
            "amount": amount,
            "coin": coin,
            "active": True,
...
async def handle_save_settings(request):
    ...
    try:
        ...
        paper = data.get("paper_trading")  # True/False
        cmd = {"action": "save_settings"}
        if pk is not None:
            cmd["private_key"] = pk
...
def create_app():
    ...
    app.router.add_post('/api/save-settings', handle_save_settings)
